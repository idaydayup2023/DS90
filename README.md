...
### 🔤 SubTrans - 智能字幕处理和翻译系统

功能强大的智能字幕处理和翻译系统，支持多种字幕格式的转换、翻译、质量评估和批量处理。
...
**技术特点:**
- **AI 模型**: Whisper (语音识别) + Ollama (大语言模型翻译)
...
# 字幕处理和翻译
cd subtrans
python main.py input.mkv --batch
...
| SubTrans | ✅ 完成 | v2.10.0 | 智能字幕处理和翻译系统，功能完整 |
| Tools | ✅ 完成 | v1.0.0 | 实用工具集，包含4个完整工具 |
